...
function login_header($title = 'Log In', $message = '', $wp_error = '') {
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __( 'http://windorbreez.com/' );
		$login_header_title = __( 'Powered by WindorBreez' );
	}
...
<!-- This is where the header information for the login page is -->

	<div id="login">
		<h1 style="text-align:center;">WindorBreez</h1>
		<br>
	<?php
